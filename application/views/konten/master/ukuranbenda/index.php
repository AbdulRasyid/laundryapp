<div class="cell auto-size padding20 bg-white">
    <h1 class="text-light">Daftar Ukuran Benda
    ...
    <ul class="breadcrumbs2 small">
        ...
        <li><a href="#">Daftar Ukuran Benda</a></li>
    </ul>
    <hr class="thin bg-grayLighter">
    <form method="post" id="myform" action="<?php echo base_url(); ?>index.php/ukuranbenda/hapus">
    ...
    <div data-role="dialog" id="dialogtambah" class="padding20" data-close-button="true" data-overlay="true" data-overlay-color="op-dark" data-overlay-click-close="true" data-width="auto" data-height="auto">
        <form method="post" action="<?php echo base_url();?>index.php/ukuranbenda/tambah">
...
<?php 
    if($this->session->flashdata('messagemode','messagecaption','messagetext','messageactive') && $this->session->flashdata('messageactive') == "ukuranbenda"){
        echo "<script>";
...
<script type = "text/javascript" language = "javascript">
         $(document).ready(function() {
            $(".editbutton").click(function(event){
                ...
                $.getJSON('http://localhost/laundryapp/index.php/ukuranbenda/tampildata/'+record.find('#kode').html(), function(data) {

                $('#namaukuran').val(data.nama_ukuran);
                $('#kodeukuran').val(data.kode_ukuran);
                $("#ubahform").attr("action", "<?php echo base_url(); ?>index.php/ukuranbenda/ubah/" + record.find('#kode').html());
