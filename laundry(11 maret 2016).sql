...
--
-- Host: localhost
-- Generation Time: Mar 11, 2016 at 05:04 
...
(30, '228864656', 'ALL', 'CBS', 'KLN', 'ALL', 1, 7000),
(31, '228864656', 'ALL', 'CKS', 'KLN', 'ALL', 2, 10000);
...
(8, 'Abimanyu', '089671907680', 'Jalan condet batu ampar', '228864656', 'PND', '03/10/2016 23:32:38', '03/11/2016 10:26:11', 'AJT', 'RGR');
...
(8, '228864656', 'Abimanyu', 21000, 25000, '03/11/2016 10:26:11', 4000);
...
ALTER TABLE `pelanggan`
  ...
  ADD CONSTRAINT `pelanggan_ibfk_2` FOREIGN KEY (`kode_pengiriman`) REFERENCES `pengiriman` (`kode_pengiriman`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pelanggan_ibfk_3` FOREIGN KEY (`kode_paket`) REFERENCES `paket_kerja` (`kode_paket`) ON DELETE CASCADE ON UPDATE CASCADE;
